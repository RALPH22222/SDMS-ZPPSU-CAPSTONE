...
?>
<aside id="adminSidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-out">
  <div class="h-16 flex items-center px-4 border-b border-gray-200">
    ...
    <button id="adminSidebarToggle" class="ml-auto md:hidden text-primary text-xl" aria-label="Toggle Sidebar">
  ...
  <nav class="py-4">
    <ul class="space-y-1">
      ...
      <li>
        <hr class="my-2 border-gray-200 py-10">
      </li>
      <li>
        <a href="../Auth/logout.php" class="flex items-center gap-3 px-4 py-20 text-dark hover:text-primary">
